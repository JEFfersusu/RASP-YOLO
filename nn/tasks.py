...
from ultralytics.nn.attention.Shuffle import ShuffleAttention

# __all__ = ( ..., "SELayer", "conv_bn_hswish", "MobileNetV3_InvertedResidual",)

# from ultralytics.nn.block.YOLOMS import C2f_MSBlock,MSBlock
# try:
#     import swattention
...
from ultralytics.nn.backbone.repghost import C2f_repghost
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3,C2f_repghost,ShuffleAttention}:
